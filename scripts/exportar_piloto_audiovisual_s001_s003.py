#!/usr/bin/env python3
"""Exporta o piloto S001–S003 pelo MediaRecorder do navegador local."""
...
def output_for(silent: bool) -> Path:
    name = (
        "capital_oculto_pilot_s001_s003_azure_antonio_silent.webm"
        if silent
        else "capital_oculto_pilot_s001_s003_azure_antonio.webm"
    )
...
def main() -> int:
    ...
    profile = Path(tempfile.mkdtemp(prefix="co-av-pilot-export-"))
